...
```
This is a group assigment and you will see 2 different approach as merged in one program.
minishell_merged is fully prepared group work.
```

```
- For program: make  // if you will have a compile error; do not forget to download additional library for related function!
- run with ./minishell
